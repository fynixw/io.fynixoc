...
draft = false
title = 'Agentic Coding时代: 软件工程的终结与新起点'
categories = ['Agentic Coding']
tags = ['AI', '软件工程', 'LLM', '工程实践']
featuredImage = "/images/ai-software-engineering-cover.jpg"
+++
...
## Agentic Coding：改变了软件开发的重心

Agentic Coding还在发展，但是它已经展示出来的魔力已经将工程师的宝贵精力从编码开发的细节中解放出来，让他们的工作重心变成更加**精确**地表达"做成什么样"的软件产品目标。
...
软件开发活动从来没有终点，有的都是一次次需求的**验收通过**。只是这一次，我们的科技书终于发展到了可以把中间的过程，放心地交给AI去"翻译", 而开发者，终于可以回到最本质的问题：**定义我们想要什么**。
